...
% Last Modified by GUIDE v2.5 26-May-2014 20:20:50
...
for i=1:1:guivar.RepeatNm
    imcreateMM( [AVT.Height,AVT.Width,guivar.NumOfFrames],[resultsDir, guivar.FileNm, '_t', num2str(i), '.bin'], 'uint8');
end
disp(['it took ' num2str(toc) 's to create the file']);
